...
public class SwiftScrumlabFlutterSharePlugin: NSObject, FlutterPlugin {
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "channel:github.com/orgs/scrum-lab/scrumlab-flutter-share", binaryMessenger: registrar.messenger())
        let instance = SwiftScrumlabFlutterSharePlugin()
