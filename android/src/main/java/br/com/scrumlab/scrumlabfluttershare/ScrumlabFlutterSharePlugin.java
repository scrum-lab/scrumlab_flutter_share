...
/**
 * ScrumlabFlutterSharePlugin
 */
public class ScrumlabFlutterSharePlugin implements MethodCallHandler {

    private final String PROVIDER_AUTH_EXT = ".fileprovider.github.com/orgs/scrum-lab/scrumlab-flutter-share";
    private Registrar _registrar;

    private ScrumlabFlutterSharePlugin(Registrar registrar) {
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "channel:github.com/orgs/scrum-lab/scrumlab-flutter-share");
        channel.setMethodCallHandler(new ScrumlabFlutterSharePlugin(registrar));
    }
